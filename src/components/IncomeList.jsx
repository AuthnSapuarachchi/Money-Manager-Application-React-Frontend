import { Download, Mail, TrendingUp, DollarSign, LoaderCircle } from "lucide-react"
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-green-50 to-white">
                ...
                <div className="flex items-center gap-2">
                    <button 
                        disabled={loading}
                        onClick={handleEmail}
                        className="flex items-center gap-2 px-3 py-2 hover:bg-green-100 rounded-lg transition-colors group disabled:opacity-50 disabled:cursor-not-allowed"
                        title="Email report"
                        aria-label="Email income report"
                    >
                       {loading ? (
                           <>
                             <LoaderCircle size={18} className="text-gray-600 group-hover:text-green-600 transition-colors animate-spin"/>
                           ...
                           <>
                             ...
                             <span className="text-sm text-gray-600 group-hover:text-green-600 transition-colors">Email</span>
                           </>
                       )}
                    </button>
                    <button 
                    ...
                    >
                        {loading ? (
                            ...
                            <>
                              ...
                              <span className="text-sm text-gray-600 group-hover:text-green-600 transition-colors">Download</span>
                            </>
                        )}                    
                    </button>
                </div>
