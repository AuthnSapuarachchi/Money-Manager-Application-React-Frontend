...
const Sidebar = () => {
    ...
    console.log("profilePictureUrl (backend field):", user?.profilePictureUrl);
    console.log("Final image URL to display:", profileImageUrl);
    console.log("===================");
                    ...
                    {profileImageUrl ? (
                        <img
                            ...
                            onError={(e) => {
                                ...
                                console.error("Attempted URL:", profileImageUrl);
