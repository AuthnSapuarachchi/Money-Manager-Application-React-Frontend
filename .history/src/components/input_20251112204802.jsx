...
const Input = ({label, value, onChange, placeholder, type = 'text', isSelect = false, options = [], required = false}) => {
   const [showPassword, setShowPassword] = useState(false);
   const toggleShowPassword = () => setShowPassword(s => !s);

   // Check if it's a select either by isSelect prop or type="select"
   const isSelectField = isSelect || type === 'select';
