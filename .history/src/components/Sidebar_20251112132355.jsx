                ...
                {SIDE_BAR_DATA.map((item, index) => {
                    ...
                    return (
                        <button 
                            ...
                            key={`menu_${index}`}
                            className="curser-pointer w-full flex items-center gap-4 text-[15px] py-3 px-4 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-colors text-left text-gray-700">
