...
const Category = () => {
    ...
    const handleUpdateCategory = async (updatedCategory) => {
        ...
        try {
            // API_ENDPOINTS.updateCategory is a function that takes categoryId
            const updateUrl = API_ENDPOINTS.updateCategory(id);
            console.log("📤 Update URL:", updateUrl);
            console.log("📤 Payload:", updatedCategory);
            
            const response = await axiosConfig.put(updateUrl, {
                name: name.trim(),
