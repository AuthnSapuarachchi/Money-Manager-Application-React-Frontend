                ...
                <div className="space-y-6">
                    ...
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">Select transaction type and apply filters to search</p>
                        </div>
                    </div>
                        ...
                        {loading ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-400 text-sm mt-2">
                                    {filters.type ? 'Try adjusting your filters or click "Apply Filters"' : 'Select a transaction type and click "Apply Filters"'}
                                </p>
                            </div>
                        ) : (
