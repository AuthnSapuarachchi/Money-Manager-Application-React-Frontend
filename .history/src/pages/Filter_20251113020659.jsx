                ...
                <div className="card p-4 mb-4">
                    ...
                    <form action="" className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-4">
                        <div>
                            ...
                            <select id="type" className="appearance-none w-full bg-white border border-gray-200 rounded-md py-2 px-3 pr-10 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-200"></select>
                        </div>
                    </form>
                </div>
            </div>
