...
const Income = () => {
    ...
    const handleEmailIncomeDetails = async () => {
        try{
            ...
            toast.loading('Preparing income report...');
            ...
            const body = encodeURIComponent(
                `Hi,\n\n` +
                `Please find my income report summary:\n\n` +
                `Total Income: ${totalAmount.toLocaleString()}\n` +
                `Total Transactions: ${totalCount}\n` +
                `Report Date: ${moment().format('YYYY-MM-DD')}\n\n` +
                `The detailed Excel file "${fileName}" has been downloaded to your computer.\n` +
            ...
            toast.success('Excel file downloaded! Email client opened - please attach the file.', {
                duration: 5000
            });
