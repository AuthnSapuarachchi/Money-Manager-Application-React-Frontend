...
const Income = () => {
    ...
    const handleEmailIncomeDetails = async () => {
        try{
            ...
            // Create download link for the attachment
            ...
            const subject = encodeURIComponent(`Income Report - ${moment().format('YYYY-MM-DD')}`);
            const body = encodeURIComponent(
                `Hi,\n\n` +
                `Please find my income report attached.\n\n` +
                `Summary:\n` +
                `━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
                ...
                `━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n` +
                `The Excel file "${fileName}" has been downloaded.\n` +
                `Please attach it to this email before sending.\n\n` +
                `Best regards`
            );
            
            // Small delay to ensure download completes before opening email
            setTimeout(() => {
                window.location.href = `mailto:?subject=${subject}&body=${body}`;
                toast.success('Excel downloaded! Email client opened - attach the file and send.', {
                    duration: 6000
                });
            }, 500);
            ...
            toast.error('Failed to prepare email with attachment');
        }
    }
